...
// MAGIC %run ../../global-setup $project_name=synthetic_transactions $catalog=lakehouse_prod_in_action
...
val volumePath = "/Volumes/lakehouse_prod_in_action/synthetic_transactions/syn_volume/"
val outputPath = f"$volumePath/table_feature_outputs/"
val inputTable = "hive_metastore.lakehouse_prod_in_action.synthetic_transactions"
