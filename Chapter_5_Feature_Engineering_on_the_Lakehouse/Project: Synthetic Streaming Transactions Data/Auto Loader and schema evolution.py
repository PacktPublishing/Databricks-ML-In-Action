...
raw_data_location = f"{volume_data_path}/schema_change_data/"
schema_location = f"{volume_data_path}/{table_name}/schema"
checkpoint_location = f"{volume_data_path}/{table_name}/checkpoint"
