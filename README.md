...
[Anastasia Prokaieva](https://www.linkedin.com/in/anastasiia-prokaieva/) began her career nine years ago as a research scientist at CEA (France), focusing on large-scale data analysis and satellite data assimilation, handling terabytes of data. She has been working within the big data analysis and machine learning domain since then. In 2021, she joined Databricks and became the regional AI subject matter expert. <br>
